...
export const TrendingAnalysis = ({ className }: TrendingAnalysisProps) => {
  ...
  const fetchInterestData = async () => {
    try {
      const data = await GoogleTrendsService.getInterestOverTime(searchKeyword, timeRange, geo);
  ...
  const fetchRegionData = async () => {
    try {
      const data = await GoogleTrendsService.getInterestByRegion(searchKeyword, geo);
      setRegionData(data);
    } catch (err) {
